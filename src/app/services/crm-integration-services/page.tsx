...
const description =
  "Connect your revenue stack. Expert CRM integration for HubSpot, Salesforce, Zoho, and custom platforms. Eliminate data silos and automate workflows."
          ...
          <div className="shell">
            ...
            <Reveal delay={0.1}>
              <p className="lead mt-8">
                Transform disconnected systems into a unified revenue engine. Expert CRM integration
                for HubSpot, Salesforce, Zoho, and custom platforms.
              </p>
            </Reveal>
          </div>
        </section>
              ...
              <article className="grid gap-x-14 gap-y-6 border-b border-rule py-12 md:grid-cols-[minmax(0,0.36fr)_minmax(0,1fr)] md:py-16">
                ...
                <div className="min-w-0">
                  <div className="copy space-y-4 [&_strong]:font-semibold [&_strong]:text-bone">
                    <p>
                      <strong>Single source of truth.</strong> When your CRM, marketing automation,
                      and analytics are connected, everyone has access to the same data. No more
                      conflicting numbers.
                    </p>
                    <p>
                      <strong>Eliminate manual data entry.</strong> Automations sync data between
                      systems, saving teams 10+ hours per week and eliminating human error.
                    </p>
                    <p>
                      <strong>Real-time lead scoring & routing.</strong> Leads are automatically
                      scored and routed to the right rep the moment they arrive. No delays, no
                      dropped leads.
                    </p>
                    <p>
                      <strong>Improved reporting & forecasting.</strong> Accurate pipeline forecasts
                      require clean, integrated data. When systems are connected, predictions
                      improve by 30-40%.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <ul className="space-y-3 text-[15px] leading-[1.6]">
                        <li>
                          <strong>API-based:</strong> Direct, real-time connections for high-volume
                          sync and custom logic.
                        </li>
                        <li>
                          <strong>Middleware platforms:</strong> n8n, Make, or Zapier for pre-built
                          connectors and easy maintenance.
                        </li>
                        <li>
                          <strong>Custom middleware:</strong> Build a custom integration layer for
                          unique requirements.
                        </li>
                      </ul>
                    </div>
                ...
                <div className="min-w-0">
                  <div className="space-y-3 text-[15px] leading-[1.6]">
                    {[
                      [
                        "Data Quality Score",
                        "100% accuracy on critical fields (email, phone, company)",
                      ],
                      ["Sync Completion Rate", "99.9% of records sync without error"],
                      [
                        "Time to Generate Reports",
                        "Automated reports ready within 1 hour of data close",
                      ],
                      [
                        "Lead Routing Accuracy",
                        "95%+ of leads routed to correct owner on first attempt",
                      ],
                    ].map(([metric, target], i) => (
                      <div
                        key={i}
