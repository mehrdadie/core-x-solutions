...
const description = "Design dashboards that inform decision-making. Data visualization best practices. Build dashboards for sales, marketing, and leadership."
          ...
          <div className="shell">
            ...
            <Reveal delay={0.1}>
              <p className="lead mt-8">
                Bad dashboards hide data. Good dashboards reveal it. Learn to design dashboards that drive decisions and accountability.
              </p>
            </Reveal>
          </div>
        </section>
            ...
            <Reveal delay={0.05}>
              <article>
                ...
                <div className="space-y-4 text-[15px] leading-[1.65] text-bone-2">
                  <p><strong>Executive Dashboard:</strong> ARR, growth rate, churn, NRR, CAC, LTV. High-level business health.</p>
                  <p><strong>Sales Dashboard:</strong> Pipeline, forecast, win rate, deal velocity. Rep performance and coaching.</p>
                  <p><strong>Marketing Dashboard:</strong> Lead generation, cost per lead, lead to opportunity, pipeline contribution.</p>
                  <p><strong>Customer Success Dashboard:</strong> Churn, NRR, health score, renewal rate. Retention and expansion focus.</p>
                  <p><strong>Operational Dashboard:</strong> Data quality, sync health, error rates. System and process monitoring.</p>
                </div>
              </article>
            </Reveal>
            ...
            <Reveal delay={0.1}>
              <div className="rounded-sm border-2 border-signal/20 bg-signal/5 p-6 md:p-8">
                ...
                <p className="text-[15px] text-bone-2 mb-4">
                  Work with a consultant to build dashboards that drive accountability and decisions.
                </p>
                <Link
                  href="#contact"
